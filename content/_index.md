    ...
    content:
      ...
      text: |-
        ...
        <div class="pub-item">
          ...
          <p class="pub-abstract"> In China, stocks that outperform on news days usually perform poorly on subsequent non-news days. This reversal on non-news days is stronger among stocks where retail investors dominante, where there is less recent good news, and where limits to arbitrage are strong. Our results suggest that past returns are contaminated by price pressure from the temporary attention-driven buying demand of retail investors. We find that the momentum effect disappears in China due to a cycle of overpricing from retail investors on news days and mispricing corrections from institutions on non-news days. Using a textual-based fundamental performance proxy, we find a strong underreaction to news in China. Such a pattern is not observed in the U.S. stock markets.</p>
          <p class="pub-links">
